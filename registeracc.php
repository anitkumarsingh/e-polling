...
if($num1 > 0) {
   die( "<h2><center>User name already exists please choose different one</center> <br><h2><center>Go to</center></h2> <a href=\"registeracc.php\"><h2><center>Register</center></h2></a>");;
}
if($num2 > 0) {
