    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="test.html"><span>Contact me</span></a></li>
        </ul>
      </div>
      <div class="logo">
        <h1><a href="index.html"><spane>e-Polling System</span> <small>Smart way to cast your vote</small></a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <p>For any technical help please contact me.</p>
        </div>
        <div class="article">
          <h2><span>Send me</span> mail</h2>
          <div class="clr"></div>
  ...
  <div class="fbg">
    <div class="fbg_resize">
      ...
      <div class="col c2">
		...
		<p>Providing services to cast vote in a particular Orangnization</p>
		<!--
      ...
      <div class="col c3">
        ...
        <p>Anit Kumar  (MCA 4th sem, RNSIT)</p>
        <p class="contact_info"> <span>Address:</span> H.No 7 B.T Krishnapp New Building, Abbigere Main Road, Jalahalli West, Bangaluru -560015<br />
